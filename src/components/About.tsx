...
const About = () => {
  ...
  return (
    <section ref={sectionRef} id="about" className="py-20 bg-gradient-to-b from-background to-secondary/10">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="animate-on-scroll opacity-0 translate-y-8 transition-all duration-700 ease-out delay-200">
              <p className="text-lg text-primary mb-6 leading-relaxed">
                Greetings, I'm Suyashi Singh, a final-year IT student at Manipal Institute of Technology, 
                passionate about software development, machine learning, and full-stack development. 
                My expertise lies in crafting cutting-edge applications that are not only efficient 
                but also user-friendly, catering to the diverse needs of clients globally.
              </p>
            </div>
          ...
          <div className="flex justify-center">
            <div 
              ref={imageRef}
              className="animate-on-scroll opacity-0 scale-95 transition-all duration-700 ease-out delay-800"
            >
